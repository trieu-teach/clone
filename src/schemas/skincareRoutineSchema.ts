...
export const zSkincareRoutineSchemaUdate = SkincareRoutineSchema.extend({
    _id: zId(), //default value will be generated by mongoose
})

export type SkincareRoutine = z.infer<typeof zSkincareRoutineSchemaUdate>;